...
public class GeneratorOptionsValidator {
    ...
    final public static Set<String> invalidForIonSchema = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("-N", "--text-code-point-range", "-E", "--decimal-exponent-range <exp_range>", "-C", "--decimal-coefficient-digit-range","-M", "--timestamps-template")));
    /**
